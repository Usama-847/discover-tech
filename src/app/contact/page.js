...
const contactSchema = {
  ...
  "@type": "ContactPage",
  name: "Contact Us - Discover Tech",
  url: "https://www.discovertech.com.pk/contact",
  description:
    "Get in touch with DiscoverTech for your technology solution needs",
};
const CONTACT_INFO = {
  email: "info@discovertech.com.pk",
  phone: "+92 310 2299985",
  whatsapp: "https://wa.me/923102299985",
  address: {
    line1: "Vella no 1827 Street No 72, Block A",
    line2: "Faisal Town F-18 Islamabad, Pakistan",
  },
};

// Bootcamp options
const BOOTCAMP_OPTIONS = [
  { name: "All Bootcamps", value: "all-bootcamps" },
  { name: "Web Development", value: "web-development" },
  { name: "Data Science", value: "data-science" },
  { name: "Digital Marketing", value: "digital-marketing" },
  { name: "Data Engineering Bootcamp", value: "data-engineering" },
  { name: "Airline Reservation", value: "airline-reservation" },
  { name: "Data Analytics Bootcamp", value: "data-analytics" },
  { name: "Business Analytics", value: "business-analytics" },
  { name: "Mern Stack Bootcamp", value: "mern-stack" },
  { name: "Mobile Development Bootcamp", value: "mobile-development" },
  { name: "Business Development", value: "business-development" },
  { name: "Web Design and Development", value: "web-design-development" },
  { name: "Cyber Security", value: "cyber-security" },
];

// EmailJS configuration - Replace with your actual credentials in .env
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const templateParams = {
      ...
      bootcamp_interest: formData.bootcampInterest || "Not specified",
      message: formData.message,
      to_name: "Discovertech Team",
    };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Ready to start your tech journey? We're here to help you choose
                the right bootcamp program and answer any questions you might
                have about our courses.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors"
                  >
                    <option value="">Select a bootcamp (optional)</option>
                    {BOOTCAMP_OPTIONS.map((option) => (
                ...
                <button
                  ...
                  className="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
